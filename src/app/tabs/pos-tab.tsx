...
/**
 * MBUMAH HARDWARE POS — POS Tab & sub-components
...
import {
  ...
  type ProductListItem, type CustomerItem, type TransactionItem, type GiftCardItem,
} from '@/lib/api';
...
import {
  ...
  TrendingUp, ArrowDownRight, AlertTriangle, DollarSign,
  Printer, ChevronDown, Tag, LayoutGrid, List, ArrowUpDown,
  ArrowUp, ArrowDown, RefreshCw, Split, Wifi, WifiOff, CloudOff, CloudLightning,
  Send, ExternalLink, Pause, UserPlus, Award, Ticket, Zap, Sparkles,
  Lightbulb, Keyboard, MessageSquare, PartyPopper, CheckCircle,
} from 'lucide-react';
