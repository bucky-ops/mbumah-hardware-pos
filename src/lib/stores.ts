...
export type AppTab = 'dashboard' | 'pos' | 'catalog' | 'inventory' | 'customers' | 'rentals' | 'financial' | 'reports' | 'transactions' | 'suppliers' | 'admin' | 'gift-cards' | 'invoices' | 'delivery-notes' | 'credits' | 'vouchers' | 'banking' | 'loyalty' | 'tax' | 'transfers' | 'messaging';
