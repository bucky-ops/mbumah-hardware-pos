...
export const PUT = withErrorBoundary(withSessionAuth(updateRentalHandler), 'RENTALS_UPDATE');
export const DELETE = withErrorBoundary(withSessionAuth(deleteRentalHandler), 'RENTALS_DELETE');
